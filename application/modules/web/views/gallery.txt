<section class="page-breadcumb-area bg-with-black">
    <div class="container text-center">
        ...
        <ul class="links">
            <li><a href="/spsvidyalaya">Home</a></li>
            <li><a href="javascript:void(0);">All Gallery</a></li>
        </ul>
    </div>
</section>
...
<section class="page-gallery-area">
    ...
    <?php }else{ ?>
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <p class="text-center"><strong><?php echo $this->lang->line('no_data_found'); ?>This is galary in else block</strong></p>
        </div>
    <?php } ?>
       </div>  
    </div>

    ...
    <body>
        <header>
            <div class="header-top-area">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-md-10 col-sm-8 col-8 hta-left1">
                            <div class="hta-box">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 col-4 hta-right text-right">
                            <div class="hta-box">
                                <a class="nav-link admission_link" style="color:#fff; border-radius:25px; border:1px solid #fff;" href="" src="./src/contact.html">Admission</a>
                            </div>
                        </div>
                    </div>
                </div>

                        ...
                        <div class="col-lg-3 offset-lg-0 col-md-4 offset-md-3 col-sm-6 col-6">
                            <div class="logo1">
                                <a href="#" style="width:100%;height:100%;position: absolute;">                        
                                    <img style="height:80%;top:10%;position: relative;" src="./assets/images/sps_logo1.jpg" alt=""  />
                                </a>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-7 col-sm-7 col-12">
                            <div class="footer-widget">
                                <div class="fw-logo">
                                    <img src="./assets/images/sps_logo1" alt=""  />
                                </div>
                                <p class="text">
                    ...
                    <!--     <div class="col-lg-3 col-md-5 col-sm-5 col-12">
                            <div class="footer-widget">
                                ...
                                <ul class="links">
                                    <li><a href="Admission-online">Aadmission</a></li>
                                    ...
                                    <li><a href="page/'.$obj->page_slug">Page_title</a></li>

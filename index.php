...
<html>
    ...
    <body>
        <header>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-md-10 col-sm-12 col-12 hta-left">
                            ...
                            <div class="hta-box"> 
                                <a href="https://wa.link/x13hy2"><span class="icon"><i class="fab fa-wapp"></i></span>
                                <p class="text">8970897995</p> </a>
                            </div>
                            <div class="hta-box">
            ...
            <div class="header-bottom-area">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-9 offset-lg-0 col-md-8 offset-md-2 col-sm-12 col-12 pad20 noSidePad">
                            <div class="menu">
            ...
            <div id="content-placeholder" style="height: 100vw;">
                <iframe id="content-wrapper-frame" src="./src/home.html" frameborder="0" width="100%" height="100%"></iframe> 
            </div>
        </header>
        <footer>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-7 col-sm-7 col-12">
                            <div class="footer-widget">
                                <div class="fw-logo">
                                    <img src="./assets/images/sps-logo1.png" alt="" style="height:100%;width:35%" />
                                </div>
                        ...
                        <div class="col-lg-3 col-md-5 col-sm-5 col-12">
                            <div class="footer-widget">
                                ...
                                <ul class="links">
                                    <li><a href="./src/contact.html">Aadmission</a></li>
